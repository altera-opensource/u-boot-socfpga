 ...
 * 2 = F2S
 */
#define CONFIG_HPS_MAINPLLGRP_VCO_PSRC		(1)
#define CONFIG_HPS_MAINPLLGRP_VCO_DENOM		(1)
#define CONFIG_HPS_MAINPLLGRP_VCO_NUMER		(47)
#define CONFIG_HPS_MAINPLLGRP_EMACA_CNT		(0)
#define CONFIG_HPS_MAINPLLGRP_EMACB_CNT		(0)
#define CONFIG_HPS_MAINPLLGRP_EMAC_PTP_CNT	(0)
#define CONFIG_HPS_MAINPLLGRP_GPIO_DB_CNT	(0)
#define CONFIG_HPS_MAINPLLGRP_SDMMC_CNT		(0)
#define CONFIG_HPS_MAINPLLGRP_S2F_USER0_CNT	(23)
#define CONFIG_HPS_MAINPLLGRP_S2F_USER1_CNT	(0)
#define CONFIG_HPS_MAINPLLGRP_HMC_PLL_REF_CNT	(23)
#define CONFIG_HPS_MAINPLLGRP_PERIPH_REF_CNT	(0)
...
#define CONFIG_HPS_PERPLLGRP_EMACA_CNT		(3)
#define CONFIG_HPS_PERPLLGRP_EMACB_CNT		(3)
#define CONFIG_HPS_PERPLLGRP_EMAC_PTP_CNT	(9)
#define CONFIG_HPS_PERPLLGRP_GPIO_DB_CNT	(9)
#define CONFIG_HPS_PERPLLGRP_SDMMC_CNT		(4)
#define CONFIG_HPS_PERPLLGRP_S2F_USER0_CNT	(0)
#define CONFIG_HPS_PERPLLGRP_S2F_USER1_CNT	(9)
#define CONFIG_HPS_PERPLLGRP_HMC_PLL_REF_CNT	(0)
...
#define CONFIG_HPS_SDMMC_SRC		(1)
#define CONFIG_HPS_S2F_USER0_SRC	(0)
#define CONFIG_HPS_S2F_USER1_SRC	(1)
 ...
 * 3 = DIV8
 */
#define CONFIG_HPS_NOCDIV_L4MAINCLK	(0)
#define CONFIG_HPS_NOCDIV_L4MPCLK	(1)
#define CONFIG_HPS_NOCDIV_L4SPCLK	(2)
...
#define CONFIG_HPS_NOCDIV_CS_PDBGCLK	(1)
...
#define CONFIG_HPS_DIV_GPIO		(3124)
...
#define CONFIG_HPS_CLK_INTOSC_HZ		(100000000)
