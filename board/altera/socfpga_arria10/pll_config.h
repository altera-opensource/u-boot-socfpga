...
#define CONFIG_HPS_MAINPLLGRP_EMACA_CNT		(47) /* 50 MHz */
#define CONFIG_HPS_MAINPLLGRP_EMACB_CNT		(47) /* 50 MHz */
#define CONFIG_HPS_MAINPLLGRP_EMAC_PTP_CNT	(23) /* 100 MHz */
#define CONFIG_HPS_MAINPLLGRP_GPIO_DB_CNT	(23) /* 100 MHz */
#define CONFIG_HPS_MAINPLLGRP_SDMMC_CNT		(11)
#define CONFIG_HPS_MAINPLLGRP_S2F_USER0_CNT	(23)
#define CONFIG_HPS_MAINPLLGRP_S2F_USER1_CNT	(23)
#define CONFIG_HPS_MAINPLLGRP_HMC_PLL_REF_CNT	(2)
#define CONFIG_HPS_MAINPLLGRP_PERIPH_REF_CNT	(23)
...
#define CONFIG_HPS_PERPLLGRP_EMACB_CNT		(39) /* 50 MHz  */
#define CONFIG_HPS_PERPLLGRP_EMAC_PTP_CNT	(19)
#define CONFIG_HPS_PERPLLGRP_GPIO_DB_CNT	(499)
#define CONFIG_HPS_PERPLLGRP_SDMMC_CNT		(19) /* 100 MHz */
#define CONFIG_HPS_PERPLLGRP_S2F_USER0_CNT	(19)
#define CONFIG_HPS_PERPLLGRP_S2F_USER1_CNT	(19)
#define CONFIG_HPS_PERPLLGRP_HMC_PLL_REF_CNT	(19)
 ...
 * 3 = DIV8
 */
#define CONFIG_HPS_NOCDIV_L4MAINCLK	(0) /* 400 MHz */
#define CONFIG_HPS_NOCDIV_L4MPCLK	(1) /* 200 MHz */
#define CONFIG_HPS_NOCDIV_L4SPCLK	(2) /* 100 MHz */
#define CONFIG_HPS_NOCDIV_CS_ATCLK	(0) /* 400 MHz */
...
#define CONFIG_HPS_CLK_I2C_HZ			CONFIG_HPS_CLK_L4_SP_HZ
