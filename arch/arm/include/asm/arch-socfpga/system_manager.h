...
#define ISWGRP_HANDOFF_BRGMODRST	SYSMGR_ISWGRP_HANDOFF0
#define ISWGRP_HANDOFF_FPGAINTF		SYSMGR_ISWGRP_HANDOFF1
#define ISWGRP_HANDOFF_FPGA2SDR		SYSMGR_ISWGRP_HANDOFF2
