...
#define SOC64_PINSEL0			0x000
#define SOC64_IOCTRL0			0x130
#define SOC64_EMAC0_USEFPGA		0x300
#define SOC64_EMAC1_USEFPGA		0x304
#define SOC64_EMAC2_USEFPGA		0x308
#define SOC64_I2C0_USEFPGA		0x30c
#define SOC64_I2C1_USEFPGA		0x310
#define SOC64_I2C_EMAC0_USEFPGA		0x314
#define SOC64_I2C_EMAC1_USEFPGA		0x318
#define SOC64_I2C_EMAC2_USEFPGA		0x31c
#define SOC64_NAND_USEFPGA		0x320
#define SOC64_SPIM0_USEFPGA		0x328
#define SOC64_SPIM1_USEFPGA		0x32c
#define SOC64_SPIS0_USEFPGA		0x330
#define SOC64_SPIS1_USEFPGA		0x334
#define SOC64_UART0_USEFPGA		0x338
#define SOC64_UART1_USEFPGA		0x33c
#define SOC64_MDIO0_USEFPGA		0x340
#define SOC64_MDIO1_USEFPGA		0x344
#define SOC64_MDIO2_USEFPGA		0x348
#define SOC64_JTAG_USEFPGA		0x350
#define SOC64_SDMMC_USEFPGA		0x354
#define SOC64_HPS_OSC_CLK		0x358
#define SOC64_IODELAY0			0x400

#define HANDOFF_FPGAINTF_USEFPGA	0x1
#define HANDOFF_FPGAINTF_NAND	BIT(4)
#define HANDOFF_FPGAINTF_SDMMC	BIT(8)
#define HANDOFF_FPGAINTF_SPIM0	BIT(16)
#define HANDOFF_FPGAINTF_SPIM1	BIT(24)
#define HANDOFF_FPGAINTF_EMAC0	BIT(0)
#define HANDOFF_FPGAINTF_EMAC1	BIT(8)
#define HANDOFF_FPGAINTF_EMAC2	BIT(16)
